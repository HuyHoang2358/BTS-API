...
class UpdatePoleCategoryRequest extends FormRequest
{
    ...
    {
        $poleCategoryId = $this->route('id');
        return [
            'name' => 'required|max:255|unique:pole_categories,name,' . $poleCategoryId,
            'code' => 'required|max:255|unique:pole_categories,code,' . $poleCategoryId,
